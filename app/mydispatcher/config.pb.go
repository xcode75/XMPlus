...
var file_app_mydispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: xray.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: xray.app.mydispatcher.Config
}
var file_app_mydispatcher_config_proto_depIdxs = []int32{
	0, // 0: xray.app.mydispatcher.Config.settings:type_name -> xray.app.mydispatcher.SessionConfig
