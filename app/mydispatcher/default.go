...
//go:generate go run github.com/xcode75/XMCore/common/errors/errorgen
...
import (
	...
	"github.com/xcode75/XMCore/common"
	"github.com/xcode75/XMCore/common/buf"
	"github.com/xcode75/XMCore/common/log"
	"github.com/xcode75/XMCore/common/net"
	"github.com/xcode75/XMCore/common/protocol"
	"github.com/xcode75/XMCore/common/session"
	"github.com/xcode75/XMCore/core"
	"github.com/xcode75/XMCore/features/dns"
	"github.com/xcode75/XMCore/features/outbound"
	"github.com/xcode75/XMCore/features/policy"
	"github.com/xcode75/XMCore/features/routing"
	routing_session "github.com/xcode75/XMCore/features/routing/session"
	"github.com/xcode75/XMCore/features/stats"
	"github.com/xcode75/XMCore/transport"
	"github.com/xcode75/XMCore/transport/pipe"
	router_ru "github.com/xcode75/XMCore/app/router"
)
...
func (d *DefaultDispatcher) getLink(ctx context.Context, network net.Network, sniffing session.SniffingRequest) (*transport.Link, *transport.Link, error) {
	...
	if user != nil && len(user.Email) > 0 {
		...
		if reject {
			...
			return nil, nil, newError("Devices limit Reached: ", user.Email)
		}
		if ok {
